...
create index ix_01_events_Reservation_id on public.events_01_Reservation(aggregate_id);
create index ix_01_aggregate_events_Reservation_id on public.aggregate_events_01_Reservation(aggregate_id);
create index ix_01_snapshot_Reservation_id on public.snapshots_01_Reservation(aggregate_id);
create index ix_01_snapshot_Reservation_aggregate_id_and_id on public.snapshots_01_Reservation(aggregate_id, id DESC);
create index ix_01_snapshot_Reservation_event_id on public.snapshots_01_Reservation(event_id);
create index ix_01_events_Reservation_timestamp on public.events_01_Reservation("timestamp");
create index ix_01_snapshots_Reservation_timestamp on public.snapshots_01_Reservation("timestamp");
...
CREATE OR REPLACE FUNCTION insert_md_01_Reservation_aggregate_event_and_return_id_opt_lock(
    IN event_in text,
    IN aggregate_id uuid,
    IN distance_from_latest_snapshot int,
    IN md text,   
