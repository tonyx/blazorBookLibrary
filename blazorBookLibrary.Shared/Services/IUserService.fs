...
type IUserService = 
    ...
    abstract member GetDistributionPointsManagedByUserAsync: userId:UserId * [<Optional; DefaultParameterValue(null)>] ?ct:CancellationToken -> Task<Result<DistributionPoint list, string>>
